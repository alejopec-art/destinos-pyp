        ...
        <div className="min-h-screen bg-[#0f172a] font-sans selection:bg-blue-500 selection:text-white relative pb-10">
            ...
            <div className="container mx-auto px-6 pt-20">
                <div className="mb-10 text-center max-w-2xl mx-auto">
                    ...
                    <div className="mt-4 p-2 bg-slate-900/40 rounded text-[10px] text-slate-500 font-mono">
                        Sesión: {user?.email} | Rol: {user?.role} | Módulos: {Object.keys(user?.modules || {}).join(', ')}
                    </div>
                </div>
                    ...
                    {modules.map((mod, idx) => (
                        <Link to={mod.link} key={idx} className="block group h-full">
                            <motion.div
                                ...
                                whileHover={{ y: -12 }}
                                className={`relative h-96 rounded-[2.5rem] p-8 flex flex-col justify-between overflow-hidden shadow-xl transition-all duration-500 ${mod.isSpecial
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    <div className={`w-20 h-20 rounded-2xl flex items-center justify-center mb-8 shadow-lg transition-transform duration-500 group-hover:scale-110 ${mod.isSpecial
                                ...
                                <div className="relative z-10 flex justify-end items-center">
                                    ...
                                    <div className={`w-14 h-14 rounded-full flex items-center justify-center transition-all duration-300 ${mod.isSpecial
